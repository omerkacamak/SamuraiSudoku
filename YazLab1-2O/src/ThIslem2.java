 ...
 * @author omer
 */
public class ThIslem2 implements Runnable {
    ...
    public ThIslem2(int[][] sudokDizi, JTextField[][] dizim, int sleep, int o, int s, int samur1, int samur2, int son1, int son2, boolean besDegil, int id) {
...
double seconds = (double)gecenZaman/1000000000;
            ...
            System.out.println("Thread2 başladı!");
